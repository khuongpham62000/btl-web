...
<div class="container-fluid box">
    ...
    <div class="row">
        ...
        <div class="col">
            ...
            <button type="button" class="btn btn-primary" style="width: 120px;" data-toggle="modal" data-target="#exampleModalCenter">
                Edit Avatar
            </button>
            <!-- Button trigger modal -->
            <button type="button" class="btn btn-danger mt-3" style="width: 120px;">
                <a href="/index.php?controller=Login&action=logout" style="color: #fff">Logout</a>
            </button>
        </div>
    </div>
